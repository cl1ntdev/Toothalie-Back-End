 ...
 */
final class Version20251116163828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE service DROP appointment_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE service ADD appointment_id INT DEFAULT NULL');
    }
}
