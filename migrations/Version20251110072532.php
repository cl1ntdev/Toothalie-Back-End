 ...
 */
final class Version20251110072532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_role ADD user_id INT NOT NULL, ADD role_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_role DROP user_id, DROP role_id');
    }
}
